...
const steps = [
  ...
  },
  {
    ...
    topics: ["Работа с текстом", "Градиентная графика и фоны", "UI/UX элементы в Fusion", "Формы и шейпы", "Ключи и кривые", "Шаблоны для переиспользования"],
  },
  {
    step: "Шаг 04",
    title: "3D Анимация",
    result: "Можешь брать референсы из рекламы крупных брендов и понимать, как их повторить",
    topics: ["Текст и 3D-пространство", "Формы в 3D", "Переход 2D → 3D", "Камера, стабилизация", "Ключи, кривые, текстуры"],
  },
  {
    step: "Шаг 05",
    title: "Частицы",
...
const ProgramSection = () => (
  <>
    ...
    <Section className="section-light" id="program">
      <FadeUp>
        <h2 className="heading-lg mb-16">Программа<br /><span className="text-primary">«Чёрная магия Fusion»</span></h2>
      </FadeUp>
