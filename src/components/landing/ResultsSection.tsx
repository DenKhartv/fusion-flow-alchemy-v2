...
const results = [
  ...
  { title: "Чек может вырасти в 2–3 раза", text: "Когда ты начинаешь делать то, что умеют не все — и брать более сложные задачи." },
  ...
  { title: "Портфолио начнёт аккуратно продавать тебя", text: "Вместо абстрактной учёбы — реальные работы и доведённые проекты." },
