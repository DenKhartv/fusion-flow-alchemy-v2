...
const cards = [
  "Как выйти из монтажёра в специалиста по дорогому визуалу",
...
const before = [
  ...
  "Не понимаешь, как повторять дорогой visual / motion",
    ...
    <Section>
      ...
      <FadeUp delay={1}>
        <p className="text-body text-muted-foreground max-w-3xl mb-12">
          Для монтажёров, которые уже работают с видео, но застряли на уровне обычного монтажа, хотят освоить Fusion и motion, выйти на более дорогие проекты и поднять чек за счёт более сильного визуала
        </p>
      </FadeUp>
