...
const cards = [
  "Как перейти от монтажёра к специалисту по более дорогому визуалу",
  "Как постепенно поднять чек за счёт уровня работ, а не количества задач",
  "Как перестать бояться сложных референсов, motion и VFX-задач",
  "Как собрать портфолио, которое мягко продаёт тебя само",
];
