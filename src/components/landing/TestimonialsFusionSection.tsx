...
const TestimonialsFusionSection = () => (
  <Section className="section-dark">
    <FadeUp>
      <h2 className="heading-lg mb-6">Что говорят<br /><span className="text-primary">после разбора Fusion</span></h2>
    </FadeUp>
    <FadeUp delay={1}>
    ...
    <div className="relative">
      <div className="flex flex-wrap justify-center gap-8 lg:gap-12">
        <FadeUp delay={2} className="basis-[260px] md:basis-[280px] lg:basis-[300px]">
          <div className="bg-white text-black rounded-2xl shadow-[0_18px_60px_rgba(0,0,0,0.55)] p-4 md:p-6 rotate-[-3deg]">
            <img
        ...
        <FadeUp delay={3} className="basis-[220px] md:basis-[260px] lg:basis-[280px] translate-y-4 lg:translate-y-10">
          <div className="bg-white text-black rounded-2xl shadow-[0_18px_60px_rgba(0,0,0,0.55)] p-4 md:p-6 rotate-[2deg]">
            <img
        ...
        <FadeUp delay={4} className="basis-[240px] md:basis-[260px] lg:basis-[300px] -translate-y-2 lg:-translate-y-6">
          <div className="bg-white text-black rounded-2xl shadow-[0_18px_60px_rgba(0,0,0,0.55)] p-4 md:p-6 rotate-[-1deg]">
            <img
        ...
        <FadeUp delay={5} className="basis-[260px] md:basis-[280px] lg:basis-[320px] translate-y-2 lg:translate-y-6">
          <div className="bg-white text-black rounded-2xl shadow-[0_18px_60px_rgba(0,0,0,0.55)] p-4 md:p-6 rotate-[4deg]">
            <img
