...
const clients = ["ВкусВилл", "Жанулька", "Евгений Никитин", "Валерия Магорцева", "Шоу Доктора"];
